...
/***/ 139:
/*!*******************************************************************!*\
  !*** D:/2023年项目前端/uniapp_style/components/uni/uni-icons/icons.js ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"商城支付学习","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 26:
/*!********************************************!*\
  !*** D:/2023年项目前端/uniapp_style/pages.json ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 33:
/*!************************************************!*\
  !*** D:/2023年项目前端/uniapp_style/store/index.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 35:
/*!***********************************************!*\
  !*** D:/2023年项目前端/uniapp_style/store/cart.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  mutations: {
    ...
    SelectAll: function SelectAll(state) {
      ...
      var data = state.cart_data.map(function (item) {
        return _objectSpread(_objectSpread({}, item), {}, {
          checked: state.sta_data.sta_checked
        });
      });
      state.cart_data = data;
      var check = !state.sta_data.sta_checked;
      state.cart_data.forEach(function (item, index) {
        _this.commit('SelectChildAll', {
          code: check,
          index: index
        });
      });
    ...
    // 子元素全选
    SelectChildAll: function SelectChildAll(state, code) {
      // 控制子级
      state.cart_data[code.index].checked = !code.code;
      var page = state.cart_data[code.index].page_list.map(function (item) {
        return _objectSpread(_objectSpread({}, item), {}, {
      ...
      // 控制父级
      var fa = state.cart_data.map(function (item, index) {
        return item.checked;
      });
      state.sta_data.sta_checked = fa.every(function (val) {
        return val == true;
      });
    },
    // 孙元素选择
    SelectSunAll: function SelectSunAll(state, code) {
      // 改变自身
      state.cart_data[code.index].page_list[code.Cindex].checked = !code.code;

      // 遍历改变父元素
      var child = state.cart_data[code.index].page_list.map(function (item, index) {
        return item.checked;
      });
      state.cart_data[code.index].checked = child.every(function (val) {
        return val == true;
      });
    ...
    // 总价
    SelectPrice: function SelectPrice(state, code) {
      state.sta_data.sta_pic = code.pic.toFixed(2);
      state.sta_data.sta_num = code.num;
    },
    // 改变当前个数
    SelectUnumber: function SelectUnumber(state, code) {
      console.log(code);
      state.cart_data[code.index].page_list[code.Cindex].com_num = code.num;
    },
    // 删除选中
    RemoveItem: function RemoveItem(state) {
      var data = state.cart_data.map(function (item, index) {
        var child = item.page_list.filter(function (item1) {
    ...
    AddItem: function AddItem(state, code) {
